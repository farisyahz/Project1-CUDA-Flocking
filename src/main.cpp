...
int main(int argc, char* argv[]) {
  projectName = "Faris Rafie Syahzani: CUDA Boids";
...
void initShaders(GLuint * program) {
  ...
  void runCUDA() {
    ...
    // execute the kernel
    #if UNIFORM_GRID && COHERENT_GRID && SHARED_MEMORY_GRID
    Boids::stepSimulationCoherentGridShared(DT);
